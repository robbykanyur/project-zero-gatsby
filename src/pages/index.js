          ...
          <>
              ...
              <div className="animated fadeInUp">
                <div className={indexStyles.hero}>
                  ...
                  <p className="is-centered is-subtitle">
                    We believe that Lynchburg's 100+ homeless residents are
                    family, and that a family cares for its own.
                  </p>
            ...
            <Block>
              <div className={indexStyles.everyPerson}>
                ...
                <p className="is-centered is-subtitle">
                  More than a hundred residents of Lynchburg, Virginia are
                  without homes, sleeping on streets and under bridges. More
                  than just residents, <strong>they are our neighbors.</strong>
                </p>
              </div>
            </Block>
            <Block
            ...
            >
              <div className={indexStyles.coordinated}>
                <h2 className="is-2 is-centered is-serif">
                  Project Zero is a coordinated effort to deliver the resources
                  of our community to those in need.
                </h2>
                <p className="is-centered is-subtitle">
                  Through partnerships with churches and other non-profit
                  organizations, we are striving to end homelessness in the city
                  of Lynchburg.
                </p>
                ...
                <div className={indexStyles.quoteWrapper}>
                  ...
                  <div className={indexStyles.quoteText}>
                    <p>
                      ...
                      attainable goal than most people realize. With your help,
                      we can accomplish this.&rdquo;
                    </p>
                  </div>
